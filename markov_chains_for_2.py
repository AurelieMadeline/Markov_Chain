...
# def make_text(max_words,word_list):
...
#         if next_words == None:
#             make_text(word_list, max_words-i)
#             return
...
def main(filename_1, filename_2):
    ...
    # new_text = make_text(40, merged_word_list)

# def main(filename):
#     word_list = make_chains(filename)

#     output_text = make_text(40, word_list) 
